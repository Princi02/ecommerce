...
// This binds the input field’s value to the old_price property of the productDetails state. The input field will always display the value stored in the state.
